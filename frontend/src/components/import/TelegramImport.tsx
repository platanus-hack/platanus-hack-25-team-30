      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <ol className="space-y-2 text-gray-700 list-decimal list-inside">
            ...
            <li>Haz clic en los tres puntos (⋮) en la esquina superior derecha y elige "Exportar historial de chat".</li>
            <li>En las opciones de exportación, desmarca todas las opciones (fotos, vídeos, archivos, stickers, etc.).</li>
            <li>En "Formato" selecciona "JSON".</li>
            <li>Ejecuta la exportación y guarda el archivo generado (result.json). Luego súbelo aquí.</li>
          </ol>
        </div>
